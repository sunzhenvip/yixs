...
#python代码实现   http://www.ximimim.top:1008/admin/common/login.shtml 获取 这个页面中 <input type="hidden" name="__token__" value="xx"> 其中value的值 和 获取标签id等于captcha的img 图片内容 并且写入文件中
